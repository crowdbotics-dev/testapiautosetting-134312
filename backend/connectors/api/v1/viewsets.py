...
class Testconnectors134312ViewSet(BaseConnectorViewSet):
    PASSWORD = settings.CONNECTOR_TESTCONNECTORS134312_PASSWORD
    USERNAME = settings.CONNECTOR_TESTCONNECTORS134312_USERNAME
    BASE_URL = "https://devstringx.com"
    AUTH_TYPE = "basic"
    IDENTIFIER = "CONNECTOR_TESTCONNECTORS134312"
